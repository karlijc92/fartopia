...
export default function MiniGame() {
  ...
  const updateProgress = useMutation({
    mutationFn: async (coins) => {
      return await base44.entities.GameProgress.update(progress.id, {
        ...
        high_score: Math.max(progress.high_score || 0, score),
      });
    },
    onSuccess: () => {
  ...
  useEffect(() => {
    if (gameActive && timeLeft > 0) {
      ...
      setGameActive(false);
      setGameOver(true);
      updateProgress.mutate(score * 10);
    }
  }, [timeLeft, gameActive]);
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-8 shadow-2xl">
          <div className="text-center mb-6">
            <h1 className="text-5xl font-black text-purple-700 mb-2">💨 TAP THE FARTS! 💨</h1>
            <p className="text-xl text-gray-700">Tap the creatures as fast as you can!</p>
          </div>
