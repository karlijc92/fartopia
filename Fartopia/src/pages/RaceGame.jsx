  ...
  const updateProgress = useMutation({
    ...
    mutationFn: async (coinsEarned) => {
      ...
      return await base44.entities.GameProgress.update(
        latestProgress.id,
        {
          coins: (latestProgress.coins || 0) + coinsEarned,
        }
      );
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-8 shadow-2xl">
          ...
          <div className="text-center mb-6">
            ...
            <h1 className="text-5xl font-black text-green-700 mb-2">
              🏁 CREATURE RACE 🏁
            </h1>

            <p className="text-xl text-gray-700">
              Pick a racer and win big!
            </p>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                {RACERS.map(racer => (
                  ...
                  <Button
                    ...
                    className="h-32 text-5xl bg-gradient-to-br from-purple-400 to-pink-400 rounded-2xl flex flex-col items-center justify-center gap-2"
                  >
                    {racer.emoji}
          ...
          {playerChoice && !racing && !gameOver && (
            ...
            <div className="text-center mb-6">
              ...
              <p className="text-xl mb-4">
                ...
                You chose:
                {' '}
                {RACERS.find(r => r.id === playerChoice)?.emoji}
                {' '}
                {RACERS.find(r => r.id === playerChoice)?.name}

              </p>

              <Button
                onClick={startRace}
                className="bg-gradient-to-r from-green-500 to-emerald-500 text-white text-2xl px-12 py-6 rounded-full shadow-2xl"
              >
          ...
          {gameOver && winner && (
            ...
            >
              ...
              <h2 className="text-4xl font-bold text-green-700 mb-4">
                ...
                {RACERS.find(r => r.id === winner)?.emoji}
                {' '}
                {RACERS.find(r => r.id === winner)?.name}
                {' '}
                Wins!
